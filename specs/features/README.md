...
| SQL: nueva categoría "Bases de datos" + dos bloques nuevos (`sql-anotado`, `sql-en-vivo`) que ejecutan consultas reales contra SQLite/WASM (`sql.js`), con verificación de resultado | [sql-en-vivo.md](sql-en-vivo.md) | ⏳ pendiente — diseño cerrado y validado con un prototipo interactivo (Artifact), implementación no empezada |
