...
| PostgreSQL: nueva tecnología (misma categoría "Bases de datos") + extensión de `sql-anotado`/`sql-en-vivo` con `motor: 'postgres'` (PGlite/WASM real, incluida RLS real con identidad simulada) + 61 lecciones en 19 módulos | [postgresql-en-vivo.md](postgresql-en-vivo.md) | 📝 diseño aprobado y validado empíricamente, pendiente de implementar |
