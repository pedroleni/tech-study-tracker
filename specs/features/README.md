...
| TypeScript: temario propio (~12 módulos / 40-48 lecciones) + compilación real (`typescript`+`@typescript/vfs`) en el editor en vivo | [typescript-compilacion-en-vivo.md](typescript-compilacion-en-vivo.md) | ⏳ pendiente — spec escrita, falta plan de implementación |
