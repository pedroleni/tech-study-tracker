...
| SQL: nueva categoría "Bases de datos" + dos bloques nuevos (`sql-anotado`, `sql-en-vivo`) que ejecutan consultas reales contra SQLite/WASM (`sql.js`), con verificación de resultado | [sql-en-vivo.md](sql-en-vivo.md) | 🚧 en curso — mecanismo implementado y verificado (esquema, motor real, tokenizador, componentes); pendiente el temario y las lecciones |
