...
- **Orden:** 540
- **Repositorio:** [github.com/pedroleni/acortador-rate-limit](https://github.com/pedroleni/acortador-rate-limit)
...
```laboratorio
{
  ...
  "contenido": "github.com/pedroleni/acortador-rate-limit — rama main con db.js, codigo.js y servidor.js completos (la infraestructura y el diseño) y limitador.js + csv.js con TODO; rama solucion con la implementación completa."
}
```
...
```laboratorio
{
  "tipo": "notas-clave",
  "items": [
    { "titulo": "Agota el cubo con curl.", "texto": "npm start, acorta una URL con POST /acortar, y visita el enlace corto varias veces seguidas con GET — verás 302 hasta agotar la capacidad, y luego un 429 real." },
...
```laboratorio
{
  ...
  "recursos": [
    {
      "titulo": "acortador-rate-limit (rama main — punto de partida)",
      "descripcion": "Clona esta rama para hacer el proyecto tú mismo.",
      "url": "https://github.com/pedroleni/acortador-rate-limit/tree/main",
      "etiqueta": "GitHub"
    },
    {
      "titulo": "acortador-rate-limit (rama solucion)",
      "descripcion": "La implementación completa, para comparar si te atascas.",
      "url": "https://github.com/pedroleni/acortador-rate-limit/tree/solucion",
      "etiqueta": "GitHub"
    },
    {
