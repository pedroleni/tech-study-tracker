...
- **Orden:** 550
- **Repositorio:** [github.com/pedroleni/procesador-ventas-streams](https://github.com/pedroleni/procesador-ventas-streams)
...
```laboratorio
{
  ...
  "contenido": "github.com/pedroleni/procesador-ventas-streams — rama main con tipos.ts, parseo-csv.ts, informe-csv.ts, procesar.ts y cli.ts completos (la infraestructura y el diseño) y divisor-lineas.ts + agregador.ts con TODO; rama solucion con la implementación completa."
}
```
...
```laboratorio
{
  "tipo": "notas-clave",
  "items": [
    { "titulo": "Genera un fichero real de cientos de miles de filas.", "texto": "npm run generar-datos -- ventas.csv 300000 — el propio generador escribe por streaming, así que ni siquiera él construye el CSV entero en memoria." },
...
```laboratorio
{
  ...
  "recursos": [
    {
      "titulo": "procesador-ventas-streams (rama main — punto de partida)",
      "descripcion": "Clona esta rama para hacer el proyecto tú mismo.",
      "url": "https://github.com/pedroleni/procesador-ventas-streams/tree/main",
      "etiqueta": "GitHub"
    },
    {
      "titulo": "procesador-ventas-streams (rama solucion)",
      "descripcion": "La implementación completa, para comparar si te atascas.",
      "url": "https://github.com/pedroleni/procesador-ventas-streams/tree/solucion",
      "etiqueta": "GitHub"
    },
    {
