...
- **Orden:** 520
- **Repositorio:** [github.com/pedroleni/api-auth-jwt](https://github.com/pedroleni/api-auth-jwt)
...
```laboratorio
{
  ...
  "contenido": "github.com/pedroleni/api-auth-jwt — rama main con tipos.ts, db.ts y servidor.ts completos (el diseño del proyecto) y contrasenas.ts + jwt.ts con TODO; rama solucion con la implementación completa."
}
```
...
```laboratorio
{
  "tipo": "notas-clave",
  "items": [
    { "titulo": "Sigue el flujo completo con curl.", "texto": "Clona el repo, npm install, npm start. Registra un usuario, haz login y copia el token que devuelve, y pásalo como 'Authorization: Bearer <token>' a GET /perfil." },
...
```laboratorio
{
  ...
  "recursos": [
    {
      "titulo": "api-auth-jwt (rama main — punto de partida)",
      "descripcion": "Clona esta rama para hacer el proyecto tú mismo.",
      "url": "https://github.com/pedroleni/api-auth-jwt/tree/main",
      "etiqueta": "GitHub"
    },
    {
      "titulo": "api-auth-jwt (rama solucion)",
      "descripcion": "La implementación completa, para comparar si te atascas.",
      "url": "https://github.com/pedroleni/api-auth-jwt/tree/solucion",
      "etiqueta": "GitHub"
    },
    {
