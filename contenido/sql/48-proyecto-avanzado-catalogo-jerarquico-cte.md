...
- **Orden:** 480
- **Repositorio:** [github.com/pedroleni/catalogo-jerarquico-cte-recursiva](https://github.com/pedroleni/catalogo-jerarquico-cte-recursiva)
...
```laboratorio
{
  ...
  "contenido": "github.com/pedroleni/catalogo-jerarquico-cte-recursiva — rama main con productosDeCategoriaYSubcategorias, la búsqueda y toda la aplicación completos; solo el término recursivo de descendientesDeCategoria() falta. Rama solucion con la CTE completa."
}
```
...
```laboratorio
{
  "tipo": "notas-clave",
  "items": [
    { "titulo": "Instala, migra y siembra — sin Docker.", "texto": "npm install, npm run migrate, npm run seed — un árbol de 3 niveles con productos repartidos en varias hojas." },
...
```laboratorio
{
  ...
  "recursos": [
    {
      "titulo": "catalogo-jerarquico-cte-recursiva (rama main — punto de partida)",
      "descripcion": "Clona esta rama para hacer el proyecto tú mismo.",
      "url": "https://github.com/pedroleni/catalogo-jerarquico-cte-recursiva/tree/main",
      "etiqueta": "GitHub"
    },
    {
      "titulo": "catalogo-jerarquico-cte-recursiva (rama solucion)",
      "descripcion": "La implementación completa, para comparar si te atascas.",
      "url": "https://github.com/pedroleni/catalogo-jerarquico-cte-recursiva/tree/solucion",
      "etiqueta": "GitHub"
    },
    {
