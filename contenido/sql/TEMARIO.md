...
| # | Lección | Repositorio |
|---|---|---|
| 46 | Proyecto avanzado: inventario transaccional | [sql-proyectos/inventario-transaccional](https://github.com/pedroleni/sql-proyectos/tree/main/inventario-transaccional) |
| 47 | Proyecto avanzado: analítica de ventas con funciones de ventana | [sql-proyectos/analitica-ventas-ventana](https://github.com/pedroleni/sql-proyectos/tree/main/analitica-ventas-ventana) |
| 48 | Proyecto avanzado: catálogo jerárquico con CTE recursiva | [sql-proyectos/catalogo-jerarquico-cte](https://github.com/pedroleni/sql-proyectos/tree/main/catalogo-jerarquico-cte) |
| 49 | Proyecto avanzado: reportes de ventas con vistas SQL | [sql-proyectos/reportes-vistas-sql](https://github.com/pedroleni/sql-proyectos/tree/main/reportes-vistas-sql) |
