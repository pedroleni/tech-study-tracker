...
- **Orden:** 640
- **Repositorio:** [github.com/pedroleni/auditoria-particionada](https://github.com/pedroleni/auditoria-particionada)
...
```laboratorio
{
  ...
  "contenido": "github.com/pedroleni/auditoria-particionada — rama main con el esquema particionado, los índices y toda la aplicación completos; solo fn_auditar_cambio() en migrations/003_trigger_auditoria.sql está recortada. Rama solucion con el trigger completo."
}
```
...
```laboratorio
{
  "tipo": "notas-clave",
  "items": [
    { "titulo": "Levanta Postgres y aplica las migraciones.", "texto": "docker compose up -d, npm install, npm run migrate — crea productos, auditoria particionada (mes anterior/actual/siguiente ya creados) y el trigger." },
...
```laboratorio
{
  ...
  "recursos": [
    {
      "titulo": "auditoria-particionada (rama main — punto de partida)",
      "descripcion": "Clona esta rama para hacer el proyecto tú mismo.",
      "url": "https://github.com/pedroleni/auditoria-particionada/tree/main",
      "etiqueta": "GitHub"
    },
    {
      "titulo": "auditoria-particionada (rama solucion)",
      "descripcion": "La implementación completa, para comparar si te atascas.",
      "url": "https://github.com/pedroleni/auditoria-particionada/tree/solucion",
      "etiqueta": "GitHub"
    },
    {
