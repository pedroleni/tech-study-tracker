...
```laboratorio
{
  ...
  "despues": "<style>\n  .contenedor { counter-reset: seccion; font-family: sans-serif; }\n  .bloque { counter-reset: parrafo; }\n  h4 { counter-increment: seccion; }\n  h4::before { content: \"Sección \" counter(seccion) \": \"; font-weight: bold; color: #7c3aed; }\n  p { counter-increment: parrafo; }\n  p::before { content: counter(parrafo) \". \"; color: #6b7280; }\n</style>\n<div class=\"contenedor\">\n  <div class=\"bloque\">\n    <h4>Introducción</h4>\n    <p>Primer párrafo</p>\n    <p>Segundo párrafo</p>\n  </div>\n  <div class=\"bloque\">\n    <h4>Desarrollo</h4>\n    <p>Primer párrafo</p>\n  </div>\n</div>",
  "nota": "Cada sección va envuelta en su propio div. Antes: parrafo se crea una sola vez, en .contenedor — nunca se reinicia, así que cuenta en GLOBAL, y el párrafo de \"Desarrollo\" aparece como \"3.\". Después: parrafo se reinicia en CADA .bloque, un ANCESTRO real de sus propios párrafos — cada sección obtiene su propia cuenta, y ese mismo párrafo vuelve a mostrar \"1.\"."
}
```
