...
| 70 | Documentar código con JSDoc | [Use JSDoc: Getting Started with JSDoc 3 (proyecto JSDoc)](https://jsdoc.app/about-getting-started) + [@returns (proyecto JSDoc)](https://jsdoc.app/tags-returns) + [@param (proyecto JSDoc)](https://jsdoc.app/tags-param) — la guía principal no cubre @returns ni la sintaxis de parámetros opcionales; se añaden las referencias dedicadas |
| 71 | Retos finales: generador de historias e interfaz de datos de vivienda | [Challenge: Silly story generator (MDN)](https://developer.mozilla.org/en-US/docs/Learn_web_development/Core/Scripting/Silly_story_generator) + [Challenge: Building a house data UI (MDN)](https://developer.mozilla.org/en-US/docs/Learn_web_development/Core/Scripting/House_data_UI) — el título original mencionaba "galería de imágenes", pero ese reto real (Challenge: Image gallery) ya se usó como fuente complementaria en la lección 42; el segundo reto de esta lección es en realidad una interfaz de búsqueda/filtrado de datos de vivienda, se corrige el título para reflejarlo |
...
- **Proyecto avanzado (`76`, 2026-08-30)**: pedido explícito tras
  ...
  [github.com/pedroleni/javascript-proyectos/gestor-de-tareas](https://github.com/pedroleni/javascript-proyectos/tree/main/gestor-de-tareas)
...
- **Proyecto avanzado 2: explorador de personajes con Vite (77,
  ...
  API). Repositorio:
  [github.com/pedroleni/javascript-proyectos/explorador-personajes](https://github.com/pedroleni/javascript-proyectos/tree/main/explorador-personajes).
...
- **Proyecto avanzado 3: buscador con TypeScript (78, 2026-08-30)**:
  ...
  Repositorio:
  [github.com/pedroleni/typescript-proyectos/buscador-personajes](https://github.com/pedroleni/typescript-proyectos/tree/main/buscador-personajes).
